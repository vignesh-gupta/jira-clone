  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        [TaskStatus.BACKLOG]: "border-transparent bg-emerald-400 text-primary hover:bg-emerald-400/80",
        [TaskStatus.DONE]: "border-transparent bg-pink-400 text-primary hover:bg-pink-400/80",
      },
    },
    defaultVariants: {
      variant: "default",
